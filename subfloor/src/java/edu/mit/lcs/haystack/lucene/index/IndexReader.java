...
/** IndexReader is an abstract class, providing an interface for accessing an
 ...
 @author Doug Cutting
 @version $Id: IndexReader.java,v 1.5 2004/07/10 00:41:40 yks Exp $
*/
public abstract class IndexReader {
  ...
  /* HAYSTACK */
	/**
	 * HAYSTACK ONLY: deletes the <code>Document</code> given the
	 * <code>uniqueID</code> for it
	 */
	abstract public void delete(Object uniqueID) throws IOException;

	/**
	 * HAYSTACK ONLY: Returns the <code>Document</code> given the
	 * <code>uniqueID</code> for it
	 */

	public Document document(Object uniqueID) throws IOException {
		int pos = getPosition(uniqueID);
		if (pos == -1) {
			return null;
		} else {
			return document(getPosition(uniqueID));
		}
	}

	/**
	 * HAYSTACK ONLY: Returns the index of the <code>Document</code> given the
	 * <code>uniqueID</code> for it
	 */
	abstract public int getPosition(Object uniqueID) throws IOException;
	/* HAYSTACK END */
