 ...
 * 
 * In either case, documents are added with the <a href="#addDocument">
 * <b>addDocument </b> </a> method. When finished adding documents, <a
 * href="#close"> <b>close </b> </a> should be called.
 * 
...
public class IndexWriter {
     ...
     * <code>edu.mit.lcs.haystack.lucene.writeLockTimeout</code> system property to
     * override.
     */
    public static long WRITE_LOCK_TIMEOUT = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.writeLockTimeout", "1000"));

    /**
     * Default value is 10000. Use
     * <code>edu.mit.lcs.haystack.lucene.commitLockTimeout</code> system property to
     * override.
     */
    public static long COMMIT_LOCK_TIMEOUT = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.commitLockTimeout", "10000"));
    ...
    /**
     * Default value is 10. Use <code>edu.mit.lcs.haystack.lucene.mergeFactor</code>
     * system property to override.
     */
    public static final int DEFAULT_MERGE_FACTOR = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.mergeFactor", "10"));

    /**
     * Default value is 10. Use <code>edu.mit.lcs.haystack.lucene.minMergeDocs</code>
     * system property to override.
     */
    public static final int DEFAULT_MIN_MERGE_DOCS = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.minMergeDocs", "10"));

    /**
     * Default value is {@link Integer#MAX_VALUE}. Use
     * <code>edu.mit.lcs.haystack.lucene.maxMergeDocs</code> system property to
     * override.
     */
    public static final int DEFAULT_MAX_MERGE_DOCS = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.maxMergeDocs", String
                    .valueOf(Integer.MAX_VALUE)));

    /**
     * Default value is 10000. Use <code>edu.mit.lcs.haystack.lucene.maxFieldLength</code>
     * system property to override.
     */
    public static final int DEFAULT_MAX_FIELD_LENGTH = Integer.parseInt(System
            .getProperty("edu.mit.csail.haystack.lucene.maxFieldLength", "10000"));
    ...
    public void addDocument(Document doc, Analyzer analyzer) throws IOException {
        DocumentWriter dw = new DocumentWriter(ramDirectory, analyzer,
    ...
    public synchronized void optimize() throws IOException {
        ...
        while (segmentInfos.size() > 1
                || (segmentInfos.size() == 1 && (SegmentReader
                        .hasDeletions(segmentInfos.info(0))
                        || segmentInfos.info(0).dir != directory || (useCompoundFile && (!SegmentReader
                        .usesCompoundFile(segmentInfos.info(0)) || SegmentReader
                        .hasSeparateNorms(segmentInfos.info(0))))))) {
    ...
    public synchronized void addIndexes(IndexReader[] readers)
        ...
        segmentInfos
                .addElement(new SegmentInfo(mergedName, docCount, directory));
    ...
    private final void deleteSegments(Vector segments) throws IOException {
        ...
        deleteFiles(readDeleteableFiles(), deletable); // try to delete
                                                       // deleteable

        for (int i = 0; i < segments.size(); i++) {
            SegmentReader reader = (SegmentReader) segments.elementAt(i);
            if (reader.directory() == this.directory)
                deleteFiles(reader.files(), deletable); // try to delete our
                                                        // files
            else
                deleteFiles(reader.files(), reader.directory()); // delete other
                                                                 // files
        }
    ...
    public final void addDocumentInternal(Document doc,
            boolean bForwardIndexes, String primaryField) throws IOException {
        
        DocumentWriter dw = new DocumentWriter(bForwardIndexes, primaryField,
