...
public:
	hash_map() : _M_ht(HASH_SIZE, hasher(), key_equal(), allocator_type()) {} // dfhuynh
  ...
  hash_map(_InputIterator __f, _InputIterator __l)
    : _M_ht(HASH_SIZE, hasher(), key_equal(), allocator_type())
...
public:
  hash_multimap() : _M_ht(HASH_SIZE, hasher(), key_equal(), allocator_type()) {}
