...
/*	
	public static Object createEventSink(OleAutomation oa) {
		int address = oa.getAddress();
		GUID riid = OleControlSite.getDefaultEventSinkGUID(new IUnknown(address));
		return new OleEventSink(null, address, riid);
	} 
	
	public static void addListener(Object sink, int id, OleListener listener) {
		OleEventSink oes = (OleEventSink) sink;
		oes.addListener(id, listener);
	}*/
}
