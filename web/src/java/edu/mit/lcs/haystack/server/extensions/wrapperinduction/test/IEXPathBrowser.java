 ...
 * @author	Andrew Hogue
 */
public class IEXPathBrowser extends Composite implements IWebBrowserNavigateListener {
    ...
    public IEXPathBrowser(Composite parent, int style, String _url) {
	super(parent, style);
	...
	return null;
	//	return this.browser.getW3CDocument();
    }
