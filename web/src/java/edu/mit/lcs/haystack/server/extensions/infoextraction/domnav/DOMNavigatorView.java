...
public class DOMNavigatorView extends DefaultComposite implements IDOMNavHandler, IDocumentFocus {
    ...
    public INode getDOM(IDOMBrowser browser) {
        if (browser != null 
                && browser.getDocument() != null 
                && browser.getDocument().getDocumentElement() != null) {
    ...
    public void runAction(INode node) {
        ...
        //System.err.println("prevSibling:" + curNodeID.toString());
     ...
     * (non-Javadoc)
     * 
     * @see edu.mit.lcs.haystack.server.infoextraction.IDocumentFocus#setFocus(edu.mit.lcs.haystack.server.extensions.wrapperinduction.dom.NodeID)
     */
